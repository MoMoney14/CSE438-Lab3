...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func windowScene(_ windowScene: UIWindowScene, performActionFor shortcutItem: UIApplicationShortcutItem, completionHandler: @escaping (Bool) -> Void) {
        ...
        if shortcutItem.type == "Red" {
            vc.color = UIColor.red
        } else if shortcutItem.type == "Orange" {
            vc.color = UIColor.orange
        } else if shortcutItem.type == "Yellow" {
            vc.color = UIColor.yellow

        } else if shortcutItem.type == "Green" {
            vc.color = UIColor.green
        }
    }
